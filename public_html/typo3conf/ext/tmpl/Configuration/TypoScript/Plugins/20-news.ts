...
plugin.tx_news {
	...
	view {
		templateRootPaths {
            ...
            //100 = EXT:tmpl/Resources/Private/Extensions/news/Templates/
        }

		partialRootPaths {
			0 = EXT:news/Resources/Private/Partials/
			1 = {$plugin.tx_news.view.partialRootPath}
            //100 = EXT:tmpl/Resources/Private/Extensions/news/Partials/
        }

		layoutRootPaths {
			0 = EXT:news/Resources/Private/Layouts/
			1 = {$plugin.tx_news.view.layoutRootPath}
            //100 = EXT:tmpl/Resources/Private/Extensions/news/Layouts/
        }
