...
/**
 * Test case for class \T3Dev\T3devcarousel\Domain\Model\Item.
 *
...
{
	/**
	 * @var \T3Dev\T3devcarousel\Domain\Model\Item
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \T3Dev\T3devcarousel\Domain\Model\Item();
	}
