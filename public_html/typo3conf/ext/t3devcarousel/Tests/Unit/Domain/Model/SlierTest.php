...
/**
 * Test case for class \T3Dev\T3devcarousel\Domain\Model\Slier.
 *
 ...
 */
class SlierTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \T3Dev\T3devcarousel\Domain\Model\Slier
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \T3Dev\T3devcarousel\Domain\Model\Slier();
	}
